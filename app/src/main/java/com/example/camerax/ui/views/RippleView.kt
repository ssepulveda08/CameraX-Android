package com.example.camerax.ui.views
...
class RippleView(context: Context?, private val attrs: AttributeSet?) : RelativeLayout(context, attrs) {
    ...
    private val MIN_RIPPLE_DURATION = 500
    private val MAX_RIPPLE_DURATION = 2500
    ...
    init {
        ...
        rippleRadius = styledAttributes.getDimension(R.styleable.RippleView_rv_radius, resources.getDimension(
        ...
        rippleColor = styledAttributes.getColor(R.styleable.RippleView_rv_color, ContextCompat.getColor(context, R.color.purple_700))
